...
const EVENTS = {
  ...
  coords: ['B. Kalpana - 9043901483', 'goudShubam - 8121319817']
  },
  neuro_nexus: {
    id: 'neuro_nexus',
  ...
  coords: ['D. Revathi - 9371345351', 'Kishore r.p - 9629885918']
  },
  promptopia: {
    id: 'promptopia',
  ...
  coords: ['R. Poojitha - 6369875736', 'Rithik Raja.t - 6379772014']
  },
  dust2data: {
    id: 'dust2data',
  ...
  coords: ['Subhashree.s.p - 8122321976', 'Dhanush.g - 8825829576']
  },
  aldea: {
    id: 'aldea',
  ...
  coords: ['M. Janani - 8248916779', 'Darshan.s - 9498383367']
  }
};
...
function initDetailsPage(){
  ...
  select.addEventListener('change', ()=>{
    ...
    actions.innerHTML = `<a class="btn cyan" href="events.html#register">Register</a> <button class="btn-outline" data-event="${ev.id}">Quick Details</button>`;
